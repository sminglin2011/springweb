...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-6">
			<input type="text" class="input-text" placeholder="项目描述" id="description1" name="description1">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">单位：</label>
		<div class="formControls col-xs-8 col-sm-6">
			<input type="text" class="input-text" placeholder="单位" id="unitMs" name="unitMs">
		</div>
	</div>
	<div class="row cl">
